...
// jsData 
function gvisDataMapIDd72b537b6617 () {
...
// jsDrawChart
function drawChartMapIDd72b537b6617() {
var data = gvisDataMapIDd72b537b6617();
var options = {};
...
options["height"] =    300;
    ...
    document.getElementById('MapIDd72b537b6617')
    );
...
callbacks.push(drawChartMapIDd72b537b6617);
})();
function displayChartMapIDd72b537b6617() {
  var pkgs = window.__gvisPackages = window.__gvisPackages || [];
  var callbacks = window.__gvisCallbacks = window.__gvisCallbacks || [];
...
<!-- jsChart -->  
<script type="text/javascript" src="https://www.google.com/jsapi?callback=displayChartMapIDd72b537b6617"></script>
 
<!-- divChart -->
  
<div id="MapIDd72b537b6617" 
...
// jsData 
function gvisDataBubbleChartIDd72b5484efaa () {
var data = new google.visualization.DataTable();
var datajson =
[
 [
...
// jsDrawChart
function drawChartBubbleChartIDd72b5484efaa() {
var data = gvisDataBubbleChartIDd72b5484efaa();
var options = {};
...
options["height"] =    700;
    ...
    document.getElementById('BubbleChartIDd72b5484efaa')
    );
    chart.draw(data,options);
...
// Add the drawChart function to the global list of callbacks
callbacks.push(drawChartBubbleChartIDd72b5484efaa);
})();
function displayChartBubbleChartIDd72b5484efaa() {
  var pkgs = window.__gvisPackages = window.__gvisPackages || [];
  var callbacks = window.__gvisCallbacks = window.__gvisCallbacks || [];
  window.clearTimeout(window.__gvisLoad);
  // The timeout is set to 100 because otherwise the container div we are
...
<!-- jsChart -->  
<script type="text/javascript" src="https://www.google.com/jsapi?callback=displayChartBubbleChartIDd72b5484efaa"></script>
 
<!-- divChart -->
  
<div id="BubbleChartIDd72b5484efaa" 
...
In de volgende oefening gaan we data in een geografische kaart plaatsen. De data is via een mobiele telefoon verzameld en kan [hier](https://raw.githubusercontent.com/witusj/R-workshop/gh-pages/Datasets/sessie%203/mean_var.csv) opgehaald worden.
